...
export class LAppModel extends CubismUserModel {
  ...
  public startMotion(
    ...
    // 從 motionSound Map 取出 motionSound 對象 // 聲音
  ...
  public preLoadMotionGroup(group: string): void {
    for (let i = 0; i < this._modelSetting.getMotionCount(group); i++) {
      ...
      console.log("-----preLoadMotionGroup-----當前正在加載聲音文件:[---"+this._modelHomeDir+soundFileName+"---]");
  ...
  public constructor() {
    ...
    this._idParamEyeLSmile = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamEyeLSmile
    );
    this._idParamEyeROpen = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamEyeROpen
    );
    this._idParamEyeRSmile = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamEyeRSmile
    );
    this._idParamEyeBallForm = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamEyeBallForm
    );
    this._idParamBrowLY = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamBrowLY
    );
    this._idParamBrowRY = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamBrowRY
    );
    this._idParamBrowLX = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamBrowLX
    );
    this._idParamBrowRX = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamBrowRX
    );
    this._idParamBrowLAngle = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamBrowLAngle
    );
    this._idParamBrowRAngle = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamBrowRAngle
    );
    ...
    this._idParamArmLA = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamArmLA
    );
    this._idParamArmRA = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamArmRA
    );
    this._idParamArmLB = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamArmLB
    );
    this._idParamArmRB = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamArmRB
    );
    this._idParamHandL = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamHandL
    );
    this._idParamHandR = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamHandR
    );
    this._idParamHairFront = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamHairFront
    );
    this._idParamHairSide = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamHairSide
    );
    this._idParamHairBack = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamHairBack
    );
    this._idParamHairFluffy = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamHairFluffy
    );
    this._idParamShoulderY = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamShoulderY
    );
    this._idParamBustX = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamBustX
    );
    this._idParamBustY = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamBustY
    );
    this._idParamBaseX = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamBaseX
    );
    this._idParamBaseY = CubismFramework.getIdManager().getId(
      CubismDefaultParameterId.ParamBaseY
    );
  ...
  _idParamEyeLSmile: CubismIdHandle;
  _idParamEyeROpen: CubismIdHandle;
  _idParamEyeRSmile: CubismIdHandle;
  _idParamEyeBallForm: CubismIdHandle;
  _idParamBrowLY: CubismIdHandle;
  _idParamBrowRY: CubismIdHandle;
  _idParamBrowLX: CubismIdHandle;
  _idParamBrowRX: CubismIdHandle;
  _idParamBrowLAngle: CubismIdHandle;
  _idParamBrowRAngle: CubismIdHandle;
  _idParamBrowLForm: CubismIdHandle;
  _idParamBrowRForm: CubismIdHandle;
  _idParamMouthForm: CubismIdHandle;//mouth form
  _idParamMouthOpenY: CubismIdHandle;//mouth openY
  ...
  _idParamArmLA: CubismIdHandle;
  _idParamArmRA: CubismIdHandle;
  _idParamArmLB: CubismIdHandle;
  _idParamArmRB: CubismIdHandle;
  _idParamHandL: CubismIdHandle;
  _idParamHandR: CubismIdHandle;
  _idParamHairFront: CubismIdHandle;
  _idParamHairSide: CubismIdHandle;
  _idParamHairBack: CubismIdHandle;
  _idParamHairFluffy: CubismIdHandle;
  _idParamShoulderY: CubismIdHandle;
  _idParamBustX: CubismIdHandle;
  _idParamBustY: CubismIdHandle;
  _idParamBaseX: CubismIdHandle;
  _idParamBaseY: CubismIdHandle;
